...
if ! hash Rscript 2>/dev/null; then
    ...
    conda install -y --force-reinstall --freeze-installed r-base r-reticulate rpy2 r-rodbc unixodbc cyrus-sasl r-cairo r-irkernel r-essentials r-languageserver -c conda-forge
